...
var _mergingCalculation = require("../../calculation/mergingCalculation.js");
...
var AbstractMergeDateTimeRefiner = exports["default"] = /*#__PURE__*/function (_MergingRefiner) {
  ...
  _inherits(AbstractMergeDateTimeRefiner, _MergingRefiner);
  return _createClass(AbstractMergeDateTimeRefiner, [{
    ...
    value: function mergeResults(textBetween, currentResult, nextResult) {
      var result = currentResult.start.isOnlyDate() ? (0, _mergingCalculation.mergeDateTimeResult)(currentResult, nextResult) : (0, _mergingCalculation.mergeDateTimeResult)(nextResult, currentResult);
