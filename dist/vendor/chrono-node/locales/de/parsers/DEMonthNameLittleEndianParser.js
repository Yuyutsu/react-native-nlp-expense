...
var PATTERN = new RegExp("(?:am\\s*?)?" + "(?:den\\s*?)?" + "([0-9]{1,2})\\." + "(?:\\s*(?:bis(?:\\s*(?:am|zum))?|\\-|\\\u2013|\\s)\\s*([0-9]{1,2})\\.?)?\\s*" + "(".concat((0, _pattern.matchAnyPattern)(_constants.MONTH_DICTIONARY), ")") + "(?:(?:-|/|,?\\s*)(".concat(_constants.YEAR_PATTERN, "(?![^\\s]\\d)))?") + "(?=\\W|$)", "i");
var DATE_GROUP = 1;
var DATE_TO_GROUP = 2;
var MONTH_NAME_GROUP = 3;
var YEAR_GROUP = 4;
var DEMonthNameLittleEndianParser = exports["default"] = /*#__PURE__*/function (_AbstractParserWithWo) {
  function DEMonthNameLittleEndianParser() {
    _classCallCheck(this, DEMonthNameLittleEndianParser);
    return _callSuper(this, DEMonthNameLittleEndianParser, arguments);
  }
  _inherits(DEMonthNameLittleEndianParser, _AbstractParserWithWo);
  return _createClass(DEMonthNameLittleEndianParser, [{
    key: "innerPattern",
