...
var PATTERN = new RegExp("(?:(?:\\,|\\(|\\（)\\s*)?" + "(?:a[mn]\\s*?)?" + "(?:(diese[mn]|letzte[mn]|n(?:ä|ae)chste[mn])\\s*)?" + "(".concat((0, _pattern.matchAnyPattern)(_constants.WEEKDAY_DICTIONARY), ")") + "(?:\\s*(?:\\,|\\)|\\）))?" + "(?:\\s*(diese|letzte|n(?:ä|ae)chste)\\s*woche)?" + "(?=\\W|$)", "i");
var PREFIX_GROUP = 1;
var SUFFIX_GROUP = 3;
var WEEKDAY_GROUP = 2;
var DEWeekdayParser = exports["default"] = /*#__PURE__*/function (_AbstractParserWithWo) {
  function DEWeekdayParser() {
    _classCallCheck(this, DEWeekdayParser);
    return _callSuper(this, DEWeekdayParser, arguments);
  }
  _inherits(DEWeekdayParser, _AbstractParserWithWo);
  return _createClass(DEWeekdayParser, [{
    key: "innerPattern",
