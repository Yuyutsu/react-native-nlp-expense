...
var DECasualTimeParser = exports["default"] = /*#__PURE__*/function (_AbstractParserWithWo) {
  function DECasualTimeParser() {
    _classCallCheck(this, DECasualTimeParser);
    return _callSuper(this, DECasualTimeParser, arguments);
  }
  _inherits(DECasualTimeParser, _AbstractParserWithWo);
  return _createClass(DECasualTimeParser, [{
    key: "innerPattern",
    ...
    value: function extractTimeComponents(component, timeKeywordPattern) {
