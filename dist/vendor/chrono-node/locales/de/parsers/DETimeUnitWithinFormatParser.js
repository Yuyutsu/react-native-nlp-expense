...
var DETimeUnitWithinFormatParser = exports["default"] = /*#__PURE__*/function (_AbstractParserWithWo) {
  function DETimeUnitWithinFormatParser() {
    _classCallCheck(this, DETimeUnitWithinFormatParser);
    return _callSuper(this, DETimeUnitWithinFormatParser, arguments);
  }
  _inherits(DETimeUnitWithinFormatParser, _AbstractParserWithWo);
  return _createClass(DETimeUnitWithinFormatParser, [{
    key: "innerPattern",
    value: function innerPattern() {
      return new RegExp("(?:in|f\xFCr|w\xE4hrend)\\s*(".concat(_constants.TIME_UNITS_PATTERN, ")(?=\\W|$)"), "i");
    }
  }, {
    key: "innerExtract",
