...
var _DECasualTimeParser = _interopRequireDefault(require("./DECasualTimeParser.js"));
...
var DATE_GROUP = 1;
var TIME_GROUP = 2;
var DECasualDateParser = exports["default"] = /*#__PURE__*/function (_AbstractParserWithWo) {
  function DECasualDateParser() {
    _classCallCheck(this, DECasualDateParser);
    return _callSuper(this, DECasualDateParser, arguments);
  }
  _inherits(DECasualDateParser, _AbstractParserWithWo);
  return _createClass(DECasualDateParser, [{
    key: "innerPattern",
    ...
    value: function innerExtract(context, match) {
      var targetDate = context.reference.getDateWithAdjustedTimezone();
      ...
      switch (dateKeyword) {
        ...
        case "heute":
          ...
          break;
        case "morgen":
          targetDate = (0, _duration.addDuration)(targetDate, {
            day: 1
          });
      ...
      if (timeKeyword) {
        component = _DECasualTimeParser["default"].extractTimeComponents(component, timeKeyword);
      }
      return component;
    }
  }]);
