...
var YEAR_GROUP = 4;
var RUMonthNameLittleEndianParser = exports["default"] = /*#__PURE__*/function (_AbstractParserWithLe) {
  function RUMonthNameLittleEndianParser() {
    _classCallCheck(this, RUMonthNameLittleEndianParser);
    return _callSuper(this, RUMonthNameLittleEndianParser, arguments);
  }
  _inherits(RUMonthNameLittleEndianParser, _AbstractParserWithLe);
  return _createClass(RUMonthNameLittleEndianParser, [{
    key: "innerPatternString",
    value: function innerPatternString(context) {
      return "(?:\u0441)?\\s*(".concat(_constants.ORDINAL_NUMBER_PATTERN, ")") + "(?:" + "\\s{0,3}(?:\u043F\u043E|-|\u2013|\u0434\u043E)?\\s{0,3}" + "(".concat(_constants.ORDINAL_NUMBER_PATTERN, ")") + ")?" + "(?:-|\\/|\\s{0,3}(?:of)?\\s{0,3})" + "(".concat((0, _pattern.matchAnyPattern)(_constants.MONTH_DICTIONARY), ")") + "(?:" + "(?:-|\\/|,?\\s{0,3})" + "(".concat(_constants.YEAR_PATTERN, "(?![^\\s]\\d))") + ")?";
    }
  }, {
    key: "innerExtract",
