...
var PATTERN = "(?:(?:\u043E\u043A\u043E\u043B\u043E|\u043F\u0440\u0438\u043C\u0435\u0440\u043D\u043E)\\s*(?:~\\s*)?)?(".concat(_constants.TIME_UNITS_PATTERN, ")").concat(_constants.REGEX_PARTS.rightBoundary);
var RUTimeUnitWithinFormatParser = exports["default"] = /*#__PURE__*/function (_AbstractParserWithWo) {
  function RUTimeUnitWithinFormatParser() {
    _classCallCheck(this, RUTimeUnitWithinFormatParser);
    return _callSuper(this, RUTimeUnitWithinFormatParser, arguments);
  }
  _inherits(RUTimeUnitWithinFormatParser, _AbstractParserWithWo);
  return _createClass(RUTimeUnitWithinFormatParser, [{
    ...
    value: function innerPattern(context) {
      return context.option.forwardDate ? new RegExp(PATTERN, _constants.REGEX_PARTS.flags) : new RegExp("(?:\u0432 \u0442\u0435\u0447\u0435\u043D\u0438\u0435|\u0432 \u0442\u0435\u0447\u0435\u043D\u0438\u0438)\\s*".concat(PATTERN), _constants.REGEX_PARTS.flags);
    }
  }, {
    key: "innerExtract",
