...
var RUTimeUnitCasualRelativeFormatParser = exports["default"] = /*#__PURE__*/function (_AbstractParserWithLe) {
  function RUTimeUnitCasualRelativeFormatParser() {
    _classCallCheck(this, RUTimeUnitCasualRelativeFormatParser);
    return _callSuper(this, RUTimeUnitCasualRelativeFormatParser, arguments);
  }
  _inherits(RUTimeUnitCasualRelativeFormatParser, _AbstractParserWithLe);
  return _createClass(RUTimeUnitCasualRelativeFormatParser, [{
    key: "innerPatternString",
    value: function innerPatternString(context) {
      return "(\u044D\u0442\u0438|\u043F\u043E\u0441\u043B\u0435\u0434\u043D\u0438\u0435|\u043F\u0440\u043E\u0448\u043B\u044B\u0435|\u0441\u043B\u0435\u0434\u0443\u044E\u0449\u0438\u0435|\u043F\u043E\u0441\u043B\u0435|\u0441\u043F\u0443\u0441\u0442\u044F|\u0447\u0435\u0440\u0435\u0437|\\+|-)\\s*(".concat(_constants.TIME_UNITS_PATTERN, ")");
    }
  }, {
    key: "innerExtract",
    value: function innerExtract(context, match) {
      var prefix = match[1].toLowerCase();
      var timeUnits = (0, _constants.parseDuration)(match[2]);
      switch (prefix) {
        case "последние":
        case "прошлые":
        case "-":
