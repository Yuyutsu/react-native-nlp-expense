...
var WEEKDAY_GROUP = 2;
var POSTFIX_GROUP = 3;
var RUWeekdayParser = exports["default"] = /*#__PURE__*/function (_AbstractParserWithLe) {
  function RUWeekdayParser() {
    _classCallCheck(this, RUWeekdayParser);
    return _callSuper(this, RUWeekdayParser, arguments);
  }
  _inherits(RUWeekdayParser, _AbstractParserWithLe);
  return _createClass(RUWeekdayParser, [{
    key: "innerPatternString",
    value: function innerPatternString(context) {
      return "(?:(?:,|\\(|\uFF08)\\s*)?" + "(?:\u0432\\s*?)?" + "(?:(\u044D\u0442\u0443|\u044D\u0442\u043E\u0442|\u043F\u0440\u043E\u0448\u043B\u044B\u0439|\u043F\u0440\u043E\u0448\u043B\u0443\u044E|\u0441\u043B\u0435\u0434\u0443\u044E\u0449\u0438\u0439|\u0441\u043B\u0435\u0434\u0443\u044E\u0449\u0443\u044E|\u0441\u043B\u0435\u0434\u0443\u044E\u0449\u0435\u0433\u043E)\\s*)?" + "(".concat((0, _pattern.matchAnyPattern)(_constants.WEEKDAY_DICTIONARY), ")") + "(?:\\s*(?:,|\\)|\uFF09))?" + "(?:\\s*\u043D\u0430\\s*(\u044D\u0442\u043E\u0439|\u043F\u0440\u043E\u0448\u043B\u043E\u0439|\u0441\u043B\u0435\u0434\u0443\u044E\u0449\u0435\u0439)\\s*\u043D\u0435\u0434\u0435\u043B\u0435)?";
    }
  }, {
    key: "innerExtract",
