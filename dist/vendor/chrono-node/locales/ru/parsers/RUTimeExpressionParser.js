...
var RUTimeExpressionParser = exports["default"] = /*#__PURE__*/function (_AbstractTimeExpressi) {
  function RUTimeExpressionParser(strictMode) {
    _classCallCheck(this, RUTimeExpressionParser);
    return _callSuper(this, RUTimeExpressionParser, [strictMode]);
  }
  _inherits(RUTimeExpressionParser, _AbstractTimeExpressi);
  return _createClass(RUTimeExpressionParser, [{
    key: "patternFlags",
    ...
    value: function primarySuffix() {
      return "(?:\\s*(?:\u0443\u0442\u0440\u0430|\u0432\u0435\u0447\u0435\u0440\u0430|\u043F\u043E\u0441\u043B\u0435 \u043F\u043E\u043B\u0443\u0434\u043D\u044F))?(?!\\/)".concat(_constants.REGEX_PARTS.rightBoundary);
    }
  }, {
    key: "extractPrimaryTimeComponents",
    value: function extractPrimaryTimeComponents(context, match) {
      var components = _superPropGet(RUTimeExpressionParser, "extractPrimaryTimeComponents", this, 3)([context, match]);
      if (components) {
