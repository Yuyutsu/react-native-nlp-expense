...
var YEAR_GROUP = 3;
var RUMonthNameParser = exports["default"] = /*#__PURE__*/function (_AbstractParserWithLe) {
  function RUMonthNameParser() {
    _classCallCheck(this, RUMonthNameParser);
    return _callSuper(this, RUMonthNameParser, arguments);
  }
  _inherits(RUMonthNameParser, _AbstractParserWithLe);
  return _createClass(RUMonthNameParser, [{
    key: "innerPatternString",
    value: function innerPatternString(context) {
      return "((?:\u0432)\\s*)?" + "(".concat((0, _pattern.matchAnyPattern)(_constants.MONTH_DICTIONARY), ")") + "\\s*" + "(?:" + "[,-]?\\s*(".concat(_constants.YEAR_PATTERN, ")?") + ")?" + "(?=[^\\s\\w]|\\s+[^0-9]|\\s+$|$)";
    }
  }, {
    key: "innerExtract",
