...
var PATTERN = new RegExp("(?:(?:\\,|\\(|\\（)\\s*)?" + "(?:(este|esta|passado|pr[oó]ximo)\\s*)?" + "(".concat((0, _pattern.matchAnyPattern)(_constants.WEEKDAY_DICTIONARY), ")") + "(?:\\s*(?:\\,|\\)|\\）))?" + "(?:\\s*(este|esta|passado|pr[óo]ximo)\\s*semana)?" + "(?=\\W|\\d|$)", "i");
var PREFIX_GROUP = 1;
var WEEKDAY_GROUP = 2;
var POSTFIX_GROUP = 3;
var PTWeekdayParser = exports["default"] = /*#__PURE__*/function (_AbstractParserWithWo) {
  function PTWeekdayParser() {
    _classCallCheck(this, PTWeekdayParser);
    return _callSuper(this, PTWeekdayParser, arguments);
  }
  _inherits(PTWeekdayParser, _AbstractParserWithWo);
  return _createClass(PTWeekdayParser, [{
    key: "innerPattern",
