...
var YEAR_GROUP = 4;
var PTMonthNameLittleEndianParser = exports["default"] = /*#__PURE__*/function (_AbstractParserWithWo) {
  function PTMonthNameLittleEndianParser() {
    _classCallCheck(this, PTMonthNameLittleEndianParser);
    return _callSuper(this, PTMonthNameLittleEndianParser, arguments);
  }
  _inherits(PTMonthNameLittleEndianParser, _AbstractParserWithWo);
  return _createClass(PTMonthNameLittleEndianParser, [{
    key: "innerPattern",
