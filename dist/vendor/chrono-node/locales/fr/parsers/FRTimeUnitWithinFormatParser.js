...
var FRTimeUnitWithinFormatParser = exports["default"] = /*#__PURE__*/function (_AbstractParserWithWo) {
  function FRTimeUnitWithinFormatParser() {
    _classCallCheck(this, FRTimeUnitWithinFormatParser);
    return _callSuper(this, FRTimeUnitWithinFormatParser, arguments);
  }
  _inherits(FRTimeUnitWithinFormatParser, _AbstractParserWithWo);
  return _createClass(FRTimeUnitWithinFormatParser, [{
    key: "innerPattern",
    value: function innerPattern() {
      return new RegExp("(?:dans|en|pour|pendant|de)\\s*(".concat(_constants.TIME_UNITS_PATTERN, ")(?=\\W|$)"), "i");
    }
  }, {
    key: "innerExtract",
