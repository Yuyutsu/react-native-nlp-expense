...
var PATTERN = new RegExp("(?:(?:\\,|\\(|\\（)\\s*)?" + "(?:(?:ce)\\s*)?" + "(".concat((0, _pattern.matchAnyPattern)(_constants.WEEKDAY_DICTIONARY), ")") + "(?:\\s*(?:\\,|\\)|\\）))?" + "(?:\\s*(dernier|prochain)\\s*)?" + "(?=\\W|\\d|$)", "i");
var WEEKDAY_GROUP = 1;
var POSTFIX_GROUP = 2;
var FRWeekdayParser = exports["default"] = /*#__PURE__*/function (_AbstractParserWithWo) {
  function FRWeekdayParser() {
    _classCallCheck(this, FRWeekdayParser);
    return _callSuper(this, FRWeekdayParser, arguments);
  }
  _inherits(FRWeekdayParser, _AbstractParserWithWo);
  return _createClass(FRWeekdayParser, [{
    key: "innerPattern",
