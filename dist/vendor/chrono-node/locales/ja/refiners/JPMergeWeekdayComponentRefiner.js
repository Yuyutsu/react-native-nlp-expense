...
var JPMergeWeekdayComponentRefiner = exports["default"] = /*#__PURE__*/function (_MergingRefiner) {
  function JPMergeWeekdayComponentRefiner() {
    _classCallCheck(this, JPMergeWeekdayComponentRefiner);
    return _callSuper(this, JPMergeWeekdayComponentRefiner, arguments);
  }
  _inherits(JPMergeWeekdayComponentRefiner, _MergingRefiner);
  return _createClass(JPMergeWeekdayComponentRefiner, [{
    key: "mergeResults",
    ...
    value: function shouldMergeResults(textBetween, currentResult, nextResult) {
      var normalDateThenWeekday = currentResult.start.isCertain("day") && nextResult.start.isOnlyWeekdayComponent() && !nextResult.start.isCertain("hour");
