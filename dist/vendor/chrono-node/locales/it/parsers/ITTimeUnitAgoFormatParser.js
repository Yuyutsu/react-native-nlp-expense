...
var PATTERN = new RegExp("(".concat(_constants.TIME_UNITS_PATTERN, ")\\s{0,5}(?:fa|prima|precedente)(?=(?:\\W|$))"), "i");
var STRICT_PATTERN = new RegExp("(".concat(_constants.TIME_UNITS_PATTERN, ")\\s{0,5}fa(?=(?:\\W|$))"), "i");
