...
var PATTERN = new RegExp("(questo|ultimo|passato|prossimo|dopo|questa|ultima|passata|prossima|\\+|-)\\s*(".concat(_constants.TIME_UNITS_PATTERN, ")(?=\\W|$)"), "i");
var ENTimeUnitCasualRelativeFormatParser = exports["default"] = /*#__PURE__*/function (_AbstractParserWithWo) {
  function ENTimeUnitCasualRelativeFormatParser() {
    ...
    return _callSuper(this, ENTimeUnitCasualRelativeFormatParser, arguments);
  }
