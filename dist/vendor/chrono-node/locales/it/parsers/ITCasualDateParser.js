...
var PATTERN = /(ora|oggi|stasera|questa sera|domani|dmn|ieri\s*sera)(?=\W|$)/i;
var ITCasualDateParser = exports["default"] = /*#__PURE__*/function (_AbstractParserWithWo) {
  function ITCasualDateParser() {
    _classCallCheck(this, ITCasualDateParser);
    return _callSuper(this, ITCasualDateParser, arguments);
  }
  _inherits(ITCasualDateParser, _AbstractParserWithWo);
  return _createClass(ITCasualDateParser, [{
    key: "innerPattern",
