...
var PATTERN = new RegExp("(?:(?:\\,|\\(|\\（)\\s*)?" + "(?:il\\s*?)?" + "(?:(questa|l'ultima|scorsa|prossima)\\s*)?" + "(".concat((0, _pattern.matchAnyPattern)(_constants.WEEKDAY_DICTIONARY), ")") + "(?:\\s*(?:\\,|\\)|\\）))?" + "(?:\\s*(questa|l'ultima|scorsa|prossima)\\s*settimana)?" + "(?=\\W|$)", "i");
var PREFIX_GROUP = 1;
var WEEKDAY_GROUP = 2;
var POSTFIX_GROUP = 3;
var ITWeekdayParser = exports["default"] = /*#__PURE__*/function (_AbstractParserWithWo) {
  function ITWeekdayParser() {
    _classCallCheck(this, ITWeekdayParser);
    return _callSuper(this, ITWeekdayParser, arguments);
  }
  _inherits(ITWeekdayParser, _AbstractParserWithWo);
  return _createClass(ITWeekdayParser, [{
    key: "innerPattern",
