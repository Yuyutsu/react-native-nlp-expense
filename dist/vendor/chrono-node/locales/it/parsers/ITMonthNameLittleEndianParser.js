...
var PATTERN = new RegExp("(?:on\\s{0,3})?" + "(".concat(_constants.ORDINAL_NUMBER_PATTERN, ")") + "(?:" + "\\s{0,3}(?:al|\\-|\\\u2013|fino|alle|allo)?\\s{0,3}" + "(".concat(_constants.ORDINAL_NUMBER_PATTERN, ")") + ")?" + "(?:-|/|\\s{0,3}(?:dal)?\\s{0,3})" + "(".concat((0, _pattern.matchAnyPattern)(_constants.MONTH_DICTIONARY), ")") + "(?:" + "(?:-|/|,?\\s{0,3})" + "(".concat(_constants.YEAR_PATTERN, "(?![^\\s]\\d))") + ")?" + "(?=\\W|$)", "i");
var DATE_GROUP = 1;
var DATE_TO_GROUP = 2;
