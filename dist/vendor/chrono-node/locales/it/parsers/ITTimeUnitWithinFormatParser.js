...
var PATTERN_WITH_PREFIX = new RegExp("(?:within|in|for)\\s*" + "(?:(?:pi\xF9 o meno|intorno|approssimativamente|verso|verso le)\\s*(?:~\\s*)?)?(".concat(_constants.TIME_UNITS_PATTERN, ")(?=\\W|$)"), "i");
var PATTERN_WITHOUT_PREFIX = new RegExp("(?:(?:pi\xF9 o meno|intorno|approssimativamente|verso|verso le)\\s*(?:~\\s*)?)?(".concat(_constants.TIME_UNITS_PATTERN, ")(?=\\W|$)"), "i");
var ENTimeUnitWithinFormatParser = exports["default"] = /*#__PURE__*/function (_AbstractParserWithWo) {
  function ENTimeUnitWithinFormatParser() {
    ...
    return _callSuper(this, ENTimeUnitWithinFormatParser, arguments);
  }
