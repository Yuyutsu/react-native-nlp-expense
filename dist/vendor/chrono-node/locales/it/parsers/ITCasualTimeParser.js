...
var PATTERN = /(?:questo|questa)?\s{0,3}(mattina|pomeriggio|sera|notte|mezzanotte|mezzogiorno)(?=\W|$)/i;
var ITCasualTimeParser = exports["default"] = /*#__PURE__*/function (_AbstractParserWithWo) {
  function ITCasualTimeParser() {
    _classCallCheck(this, ITCasualTimeParser);
    return _callSuper(this, ITCasualTimeParser, arguments);
  }
  _inherits(ITCasualTimeParser, _AbstractParserWithWo);
  return _createClass(ITCasualTimeParser, [{
    key: "innerPattern",
    ...
    value: function innerExtract(context, match) {
      ...
      switch (match[1].toLowerCase()) {
        case "pomeriggio":
          component.imply("meridiem", _index.Meridiem.PM);
        ...
        case "mezzanotte":
          ...
          break;
        case "mattina":
          component.imply("meridiem", _index.Meridiem.AM);
