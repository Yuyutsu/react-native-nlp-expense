...
var PATTERN = new RegExp("(questo|ultimo|scorso|prossimo|dopo\\s*questo|questa|ultima|scorsa|prossima\\s*questa)\\s*(".concat((0, _pattern.matchAnyPattern)(_constants.TIME_UNIT_DICTIONARY), ")(?=\\s*)") + "(?=\\W|$)", "i");
var MODIFIER_WORD_GROUP = 1;
var RELATIVE_WORD_GROUP = 2;
var ITRelativeDateFormatParser = exports["default"] = /*#__PURE__*/function (_AbstractParserWithWo) {
  function ITRelativeDateFormatParser() {
    _classCallCheck(this, ITRelativeDateFormatParser);
    return _callSuper(this, ITRelativeDateFormatParser, arguments);
  }
  _inherits(ITRelativeDateFormatParser, _AbstractParserWithWo);
  return _createClass(ITRelativeDateFormatParser, [{
    key: "innerPattern",
