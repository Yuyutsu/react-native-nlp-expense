...
var PATTERN = new RegExp("(".concat((0, _pattern.matchAnyPattern)(_constants.MONTH_DICTIONARY), ")") + "(?:-|/|\\s*,?\\s*)" + "(".concat(_constants.ORDINAL_NUMBER_PATTERN, ")(?!\\s*(?:am|pm))\\s*") + "(?:" + "(?:al|\\-|\\alle|\\del|\\s)\\s*" + "(".concat(_constants.ORDINAL_NUMBER_PATTERN, ")\\s*") + ")?" + "(?:" + "(?:-|/|\\s*,?\\s*)" + "(".concat(_constants.YEAR_PATTERN, ")") + ")?" + "(?=\\W|$)(?!\\:\\d)", "i");
...
var ENMonthNameMiddleEndianParser = exports["default"] = /*#__PURE__*/function (_AbstractParserWithWo) {
  function ENMonthNameMiddleEndianParser() {
    ...
    return _callSuper(this, ENMonthNameMiddleEndianParser, arguments);
  }
