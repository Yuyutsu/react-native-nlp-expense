...
var NLTimeUnitWithinFormatParser = exports["default"] = /*#__PURE__*/function (_AbstractParserWithWo) {
  function NLTimeUnitWithinFormatParser() {
    _classCallCheck(this, NLTimeUnitWithinFormatParser);
    return _callSuper(this, NLTimeUnitWithinFormatParser, arguments);
  }
  _inherits(NLTimeUnitWithinFormatParser, _AbstractParserWithWo);
  return _createClass(NLTimeUnitWithinFormatParser, [{
    key: "innerPattern",
    value: function innerPattern() {
      return new RegExp("(?:binnen|in|binnen de|voor)\\s*" + "(" + _constants.TIME_UNITS_PATTERN + ")" + "(?=\\W|$)", "i");
    }
  }, {
    key: "innerExtract",
