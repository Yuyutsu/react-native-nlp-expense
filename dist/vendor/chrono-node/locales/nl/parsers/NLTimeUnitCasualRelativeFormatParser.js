...
var PATTERN = new RegExp("(dit|deze|vorig|afgelopen|(?:aan)?komend|over|\\+|-)e?\\s*(".concat(_constants.TIME_UNITS_PATTERN, ")(?=\\W|$)"), "i");
var PREFIX_WORD_GROUP = 1;
var TIME_UNIT_WORD_GROUP = 2;
var NLTimeUnitCasualRelativeFormatParser = exports["default"] = /*#__PURE__*/function (_AbstractParserWithWo) {
  function NLTimeUnitCasualRelativeFormatParser() {
    _classCallCheck(this, NLTimeUnitCasualRelativeFormatParser);
    return _callSuper(this, NLTimeUnitCasualRelativeFormatParser, arguments);
  }
  _inherits(NLTimeUnitCasualRelativeFormatParser, _AbstractParserWithWo);
  return _createClass(NLTimeUnitCasualRelativeFormatParser, [{
    key: "innerPattern",
    ...
    value: function innerExtract(context, match) {
      ...
      var timeUnits = (0, _constants.parseDuration)(match[TIME_UNIT_WORD_GROUP]);
      switch (prefix) {
        case "vorig":
        case "afgelopen":
        case "-":
