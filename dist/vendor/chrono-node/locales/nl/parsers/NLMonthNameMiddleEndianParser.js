...
var PATTERN = new RegExp("(?:on\\s*?)?" + "(".concat(_constants.ORDINAL_NUMBER_PATTERN, ")") + "(?:\\s*" + "(?:tot|\\-|\\–|until|through|till|\\s)\\s*" + "(".concat(_constants.ORDINAL_NUMBER_PATTERN, ")") + ")?" + "(?:-|/|\\s*(?:of)?\\s*)" + "(" + (0, _pattern.matchAnyPattern)(_constants.MONTH_DICTIONARY) + ")" + "(?:" + "(?:-|/|,?\\s*)" + "(".concat(_constants.YEAR_PATTERN, "(?![^\\s]\\d))") + ")?" + "(?=\\W|$)", "i");
var MONTH_NAME_GROUP = 3;
var DATE_GROUP = 1;
var DATE_TO_GROUP = 2;
var YEAR_GROUP = 4;
var NLMonthNameMiddleEndianParser = exports["default"] = /*#__PURE__*/function (_AbstractParserWithWo) {
  function NLMonthNameMiddleEndianParser() {
    _classCallCheck(this, NLMonthNameMiddleEndianParser);
    return _callSuper(this, NLMonthNameMiddleEndianParser, arguments);
  }
  _inherits(NLMonthNameMiddleEndianParser, _AbstractParserWithWo);
  return _createClass(NLMonthNameMiddleEndianParser, [{
    key: "innerPattern",
