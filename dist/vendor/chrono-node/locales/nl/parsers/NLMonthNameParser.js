...
var PATTERN = new RegExp("(".concat((0, _pattern.matchAnyPattern)(_constants.MONTH_DICTIONARY), ")") + "\\s*" + "(?:" + "[,-]?\\s*(".concat(_constants.YEAR_PATTERN, ")?") + ")?" + "(?=[^\\s\\w]|\\s+[^0-9]|\\s+$|$)", "i");
var MONTH_NAME_GROUP = 1;
var YEAR_GROUP = 2;
var NLMonthNameParser = exports["default"] = /*#__PURE__*/function (_AbstractParserWithWo) {
  function NLMonthNameParser() {
    _classCallCheck(this, NLMonthNameParser);
    return _callSuper(this, NLMonthNameParser, arguments);
  }
  _inherits(NLMonthNameParser, _AbstractParserWithWo);
  return _createClass(NLMonthNameParser, [{
    key: "innerPattern",
    ...
    value: function innerExtract(context, match) {
      ...
      var month = _constants.MONTH_DICTIONARY[monthName.toLowerCase()];
