...
var PATTERN = new RegExp("(?<prefix>上|下|这)(?:个)?(?:星期|礼拜|周)(?<weekday>" + Object.keys(_constants.WEEKDAY_OFFSET).join("|") + ")");
var ZHHansRelationWeekdayParser = exports["default"] = /*#__PURE__*/function (_AbstractParserWithWo) {
  function ZHHansRelationWeekdayParser() {
    _classCallCheck(this, ZHHansRelationWeekdayParser);
    return _callSuper(this, ZHHansRelationWeekdayParser, arguments);
  }
  _inherits(ZHHansRelationWeekdayParser, _AbstractParserWithWo);
  return _createClass(ZHHansRelationWeekdayParser, [{
    key: "innerPattern",
