...
var PATTERN = new RegExp("(?:星期|礼拜|周)(?<weekday>" + Object.keys(_constants.WEEKDAY_OFFSET).join("|") + ")");
var ZHHansWeekdayParser = exports["default"] = /*#__PURE__*/function (_AbstractParserWithWo) {
  function ZHHansWeekdayParser() {
    _classCallCheck(this, ZHHansWeekdayParser);
    return _callSuper(this, ZHHansWeekdayParser, arguments);
  }
  _inherits(ZHHansWeekdayParser, _AbstractParserWithWo);
  return _createClass(ZHHansWeekdayParser, [{
    key: "innerPattern",
