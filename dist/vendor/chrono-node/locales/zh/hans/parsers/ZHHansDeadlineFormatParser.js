...
var PATTERN = new RegExp("(\\d+|[" + Object.keys(_constants.NUMBER).join("") + "]+|半|几)(?:\\s*)" + "(?:个)?" + "(秒(?:钟)?|分钟|小时|钟|日|天|星期|礼拜|月|年)" + "(?:(?:之|过)?后|(?:之)?内)", "i");
var NUMBER_GROUP = 1;
var UNIT_GROUP = 2;
var ZHHansDeadlineFormatParser = exports["default"] = /*#__PURE__*/function (_AbstractParserWithWo) {
  function ZHHansDeadlineFormatParser() {
    _classCallCheck(this, ZHHansDeadlineFormatParser);
    return _callSuper(this, ZHHansDeadlineFormatParser, arguments);
  }
  _inherits(ZHHansDeadlineFormatParser, _AbstractParserWithWo);
  return _createClass(ZHHansDeadlineFormatParser, [{
    key: "innerPattern",
