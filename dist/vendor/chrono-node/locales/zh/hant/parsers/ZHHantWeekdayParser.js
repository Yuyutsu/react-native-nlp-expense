...
var PATTERN = new RegExp("(?:星期|禮拜|週)(?<weekday>" + Object.keys(_constants.WEEKDAY_OFFSET).join("|") + ")");
var ZHHantWeekdayParser = exports["default"] = /*#__PURE__*/function (_AbstractParserWithWo) {
  function ZHHantWeekdayParser() {
    _classCallCheck(this, ZHHantWeekdayParser);
    return _callSuper(this, ZHHantWeekdayParser, arguments);
  }
  _inherits(ZHHantWeekdayParser, _AbstractParserWithWo);
  return _createClass(ZHHantWeekdayParser, [{
    key: "innerPattern",
