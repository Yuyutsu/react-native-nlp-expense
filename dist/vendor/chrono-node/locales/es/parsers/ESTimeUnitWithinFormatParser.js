...
var ESTimeUnitWithinFormatParser = exports["default"] = /*#__PURE__*/function (_AbstractParserWithWo) {
  function ESTimeUnitWithinFormatParser() {
    _classCallCheck(this, ESTimeUnitWithinFormatParser);
    return _callSuper(this, ESTimeUnitWithinFormatParser, arguments);
  }
  _inherits(ESTimeUnitWithinFormatParser, _AbstractParserWithWo);
  return _createClass(ESTimeUnitWithinFormatParser, [{
    key: "innerPattern",
    value: function innerPattern() {
      return new RegExp("(?:en|por|durante|de|dentro de)\\s*(".concat(_constants.TIME_UNITS_PATTERN, ")(?=\\W|$)"), "i");
    }
  }, {
    key: "innerExtract",
