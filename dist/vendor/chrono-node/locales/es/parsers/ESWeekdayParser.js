...
var PATTERN = new RegExp("(?:(?:\\,|\\(|\\（)\\s*)?" + "(?:(este|esta|pasado|pr[oó]ximo)\\s*)?" + "(".concat((0, _pattern.matchAnyPattern)(_constants.WEEKDAY_DICTIONARY), ")") + "(?:\\s*(?:\\,|\\)|\\）))?" + "(?:\\s*(este|esta|pasado|pr[óo]ximo)\\s*semana)?" + "(?=\\W|\\d|$)", "i");
var PREFIX_GROUP = 1;
var WEEKDAY_GROUP = 2;
var POSTFIX_GROUP = 3;
var ESWeekdayParser = exports["default"] = /*#__PURE__*/function (_AbstractParserWithWo) {
  function ESWeekdayParser() {
    _classCallCheck(this, ESWeekdayParser);
    return _callSuper(this, ESWeekdayParser, arguments);
  }
  _inherits(ESWeekdayParser, _AbstractParserWithWo);
  return _createClass(ESWeekdayParser, [{
    key: "innerPattern",
