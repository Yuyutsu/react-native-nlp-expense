...
var ENYearMonthDayParser = exports["default"] = /*#__PURE__*/function (_AbstractParserWithWo) {
  function ENYearMonthDayParser(strictMonthDateOrder) {
    var _this;
    _classCallCheck(this, ENYearMonthDayParser);
    _this = _callSuper(this, ENYearMonthDayParser);
    _defineProperty(_this, "strictMonthDateOrder", void 0);
    _this.strictMonthDateOrder = strictMonthDateOrder;
    return _this;
  }
  _inherits(ENYearMonthDayParser, _AbstractParserWithWo);
