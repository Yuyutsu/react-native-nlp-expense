...
var PATTERN_WITH_OPTIONAL_PREFIX = new RegExp("(?:(?:within|in|for)\\s*)?" + "(?:(?:about|around|roughly|approximately|just)\\s*(?:~\\s*)?)?(".concat(_constants.TIME_UNITS_PATTERN, ")(?=\\W|$)"), "i");
var PATTERN_WITH_PREFIX = new RegExp("(?:within|in|for)\\s*" + "(?:(?:about|around|roughly|approximately|just)\\s*(?:~\\s*)?)?(".concat(_constants.TIME_UNITS_PATTERN, ")(?=\\W|$)"), "i");
var PATTERN_WITH_PREFIX_STRICT = new RegExp("(?:within|in|for)\\s*" + "(?:(?:about|around|roughly|approximately|just)\\s*(?:~\\s*)?)?(".concat(_constants.TIME_UNITS_NO_ABBR_PATTERN, ")(?=\\W|$)"), "i");
var ENTimeUnitWithinFormatParser = exports["default"] = /*#__PURE__*/function (_AbstractParserWithWo) {
