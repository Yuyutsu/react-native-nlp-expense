...
var PATTERN = new RegExp("(".concat(_constants.TIME_UNITS_PATTERN, ")\\s{0,5}(?:later|after|from now|henceforth|forward|out)") + "(?=(?:\\W|$))", "i");
var STRICT_PATTERN = new RegExp("(".concat(_constants.TIME_UNITS_NO_ABBR_PATTERN, ")\\s{0,5}(later|after|from now)(?=\\W|$)"), "i");
...
var ENTimeUnitLaterFormatParser = exports["default"] = /*#__PURE__*/function (_AbstractParserWithWo) {
  ...
  return _createClass(ENTimeUnitLaterFormatParser, [{
    ...
    value: function innerExtract(context, match) {
      var timeUnits = (0, _constants.parseDuration)(match[GROUP_NUM_TIMEUNITS]);
      if (!timeUnits) {
        return null;
      }
