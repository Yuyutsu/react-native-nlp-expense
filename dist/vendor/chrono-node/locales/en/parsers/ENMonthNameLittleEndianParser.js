...
var PATTERN = new RegExp("(?:on\\s{0,3})?" + "(".concat(_constants.ORDINAL_NUMBER_PATTERN, ")") + "(?:" + "\\s{0,3}(?:to|\\-|\\\u2013|until|through|till)?\\s{0,3}" + "(".concat(_constants.ORDINAL_NUMBER_PATTERN, ")") + ")?" + "(?:-|/|\\s{0,3}(?:of)?\\s{0,3})" + "(".concat((0, _pattern.matchAnyPattern)(_constants.MONTH_DICTIONARY), ")") + "(?:" + "(?:-|/|,?\\s{0,3})" + "(".concat(_constants.YEAR_PATTERN, "(?!\\w))") + ")?" + "(?=\\W|$)", "i");
var DATE_GROUP = 1;
var DATE_TO_GROUP = 2;
var MONTH_NAME_GROUP = 3;
var YEAR_GROUP = 4;
var ENMonthNameLittleEndianParser = exports["default"] = /*#__PURE__*/function (_AbstractParserWithWo) {
  ...
  _inherits(ENMonthNameLittleEndianParser, _AbstractParserWithWo);
