...
var PATTERN = new RegExp("(".concat((0, _pattern.matchAnyPattern)(_constants.MONTH_DICTIONARY), ")") + "(?:-|/|\\s*,?\\s*)" + "(".concat(_constants.ORDINAL_NUMBER_PATTERN, ")(?!\\s*(?:am|pm))\\s*") + "(?:" + "(?:to|\\-)\\s*" + "(".concat(_constants.ORDINAL_NUMBER_PATTERN, ")\\s*") + ")?" + "(?:" + "(?:-|/|\\s*,\\s*|\\s+)" + "(".concat(_constants.YEAR_PATTERN, ")") + ")?" + "(?=\\W|$)(?!\\:\\d)", "i");
var MONTH_NAME_GROUP = 1;
var DATE_GROUP = 2;
var DATE_TO_GROUP = 3;
var YEAR_GROUP = 4;
var ENMonthNameMiddleEndianParser = exports["default"] = /*#__PURE__*/function (_AbstractParserWithWo) {
  function ENMonthNameMiddleEndianParser(shouldSkipYearLikeDate) {
    var _this;
    _classCallCheck(this, ENMonthNameMiddleEndianParser);
    _this = _callSuper(this, ENMonthNameMiddleEndianParser);
    _defineProperty(_this, "shouldSkipYearLikeDate", void 0);
    _this.shouldSkipYearLikeDate = shouldSkipYearLikeDate;
    return _this;
  }
  _inherits(ENMonthNameMiddleEndianParser, _AbstractParserWithWo);
