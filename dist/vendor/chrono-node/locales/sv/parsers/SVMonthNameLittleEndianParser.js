...
var PATTERN = new RegExp("(?:den\\s*?)?" + "([0-9]{1,2})" + "(?:\\s*(?:till|\\-|\\\u2013|\\s)\\s*([0-9]{1,2}))?\\s*" + "(".concat((0, _pattern.matchAnyPattern)(_constants.MONTH_DICTIONARY), ")") + "(?:(?:-|/|,?\\s*)([0-9]{4}(?![^\\s]\\d)))?" + "(?=\\W|$)", "i");
var DATE_GROUP = 1;
var DATE_TO_GROUP = 2;
var MONTH_NAME_GROUP = 3;
var YEAR_GROUP = 4;
var SVMonthNameLittleEndianParser = exports["default"] = /*#__PURE__*/function (_AbstractParserWithWo) {
  function SVMonthNameLittleEndianParser() {
    _classCallCheck(this, SVMonthNameLittleEndianParser);
    return _callSuper(this, SVMonthNameLittleEndianParser, arguments);
  }
  _inherits(SVMonthNameLittleEndianParser, _AbstractParserWithWo);
  return _createClass(SVMonthNameLittleEndianParser, [{
    key: "innerPattern",
