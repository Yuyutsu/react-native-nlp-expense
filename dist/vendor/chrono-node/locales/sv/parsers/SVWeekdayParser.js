...
var PATTERN = new RegExp("(?:(?:\\,|\\(|\\（)\\s*)?" + "(?:på\\s*?)?" + "(?:(förra|senaste|nästa|kommande)\\s*)?" + "(".concat((0, _pattern.matchAnyPattern)(_constants.WEEKDAY_DICTIONARY), ")") + "(?:\\s*(?:\\,|\\)|\\）))?" + "(?:\\s*(förra|senaste|nästa|kommande)\\s*vecka)?" + "(?=\\W|$)", "i");
var PREFIX_GROUP = 1;
var SUFFIX_GROUP = 3;
var WEEKDAY_GROUP = 2;
var SVWeekdayParser = exports["default"] = /*#__PURE__*/function (_AbstractParserWithWo) {
  function SVWeekdayParser() {
    _classCallCheck(this, SVWeekdayParser);
    return _callSuper(this, SVWeekdayParser, arguments);
  }
  _inherits(SVWeekdayParser, _AbstractParserWithWo);
  return _createClass(SVWeekdayParser, [{
    key: "innerPattern",
    ...
    value: function innerExtract(context, match) {
      ...
      var offset = _constants.WEEKDAY_DICTIONARY[dayOfWeek];
