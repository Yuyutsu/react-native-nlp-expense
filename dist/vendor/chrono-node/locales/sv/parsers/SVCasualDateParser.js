...
var PATTERN = new RegExp("(nu|idag|imorgon|\xF6vermorgon|ig\xE5r|f\xF6rrg\xE5r|i\\s*f\xF6rrg\xE5r)" + "(?:\\s*(?:p\xE5\\s*)?(morgonen?|f\xF6rmiddagen?|middagen?|eftermiddagen?|kv\xE4llen?|natten?|midnatt))?" + "(?=\\W|$)", "i");
var DATE_GROUP = 1;
var TIME_GROUP = 2;
var SVCasualDateParser = exports["default"] = /*#__PURE__*/function (_AbstractParserWithWo) {
  function SVCasualDateParser() {
    _classCallCheck(this, SVCasualDateParser);
    return _callSuper(this, SVCasualDateParser, arguments);
  }
  _inherits(SVCasualDateParser, _AbstractParserWithWo);
  return _createClass(SVCasualDateParser, [{
    key: "innerPattern",
    ...
    value: function innerExtract(context, match) {
      ...
      switch (dateKeyword) {
        ...
        case "igår":
          ...
          (0, _dates.implySimilarTime)(component, previousDay);
          break;
        case "förrgår":
        case "i förrgår":
          var twoDaysAgo = new Date(targetDate.getTime());
          twoDaysAgo.setDate(twoDaysAgo.getDate() - 2);
          (0, _dates.assignSimilarDate)(component, twoDaysAgo);
          (0, _dates.implySimilarTime)(component, twoDaysAgo);
          break;
      }
      switch (timeKeyword) {
        case "morgon":
