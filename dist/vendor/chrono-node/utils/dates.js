...
function assignSimilarTime(component, target) {
  ...
  component.assign("meridiem", target.getHours() < 12 ? _types.Meridiem.AM : _types.Meridiem.PM);
}
...
function implySimilarTime(component, target) {
  ...
  component.imply("meridiem", target.getHours() < 12 ? _types.Meridiem.AM : _types.Meridiem.PM);
}