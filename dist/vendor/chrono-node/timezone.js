...
var TIMEZONE_ABBR_MAP = exports.TIMEZONE_ABBR_MAP = {
  ACDT: 630,
  ACST: 570,
  ADT: -180,
  AEDT: 660,
  ...
  CET: {
    ...
    dstStart: function dstStart(year) {
      return getLastWeekdayOfMonth(year, _types.Month.MARCH, _types.Weekday.SUNDAY, 2);
    },
    dstEnd: function dstEnd(year) {
      return getLastWeekdayOfMonth(year, _types.Month.OCTOBER, _types.Weekday.SUNDAY, 3);
    }
  },
  CHADT: 825,
  CHAST: 765,
  ...
  CT: {
    ...
    dstStart: function dstStart(year) {
      return getNthWeekdayOfMonth(year, _types.Month.MARCH, _types.Weekday.SUNDAY, 2, 2);
    },
    dstEnd: function dstEnd(year) {
      return getNthWeekdayOfMonth(year, _types.Month.NOVEMBER, _types.Weekday.SUNDAY, 1, 2);
    }
  },
  CVT: -60,
  CXT: 420,
...
function toTimezoneOffset(timezoneInput, date) {
  ...
  var matchedTimezone = (_timezoneOverrides$ti = timezoneOverrides[timezoneInput]) !== null && _timezoneOverrides$ti !== void 0 ? _timezoneOverrides$ti : TIMEZONE_ABBR_MAP[timezoneInput];
